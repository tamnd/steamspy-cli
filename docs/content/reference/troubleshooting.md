...
Most of these come down to network reality or how steamspy serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

steamspy rate-limits like any public site. steamspy already paces
...
Where a surface is gated, steamspy reads a cookie or token you supply
...
`steamspy`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what steamspy actually did
