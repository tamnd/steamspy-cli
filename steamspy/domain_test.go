...
// HTTP behaviour is covered in steamspy_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "steamspy://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("steamspy", "about")
	if err != nil || got.String() != "steamspy://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want steamspy://page/about", got.String(), err)
	}
}
